import{i as e}from"./preload-helper-CT_b8DTk.js";import{n as t,t as n}from"./Header-gX9Ifuwn.js";var r=e((()=>{})),i,a=e((()=>{t(),r(),i=()=>{let e=document.createElement(`article`),t=null,r=null,i=()=>{let e=document.getElementsByTagName(`article`)[0];e.replaceChild(c(),e.firstChild)},a=()=>{t={name:`Jane Doe`},i()},o=()=>{t=null,i()},s=()=>{t={name:`Jane Doe`},i()},c=()=>n({onLogin:a,onLogout:o,onCreateAccount:s,user:t});return r=c(),e.appendChild(r),e.insertAdjacentHTML(`beforeend`,`
...
`),e}})),o,s,c,l,u,d,f;e((()=>{a(),{expect:o,userEvent:s,within:c}=__STORYBOOK_MODULE_TEST__,l={title:`Example/Page`,render:()=>i(),parameters:{layout:`fullscreen`}},u={},d={play:async({canvasElement:e})=>{let t=c(e),n=t.getByRole(`button`,{name:/Log in/i});await o(n).toBeInTheDocument(),await s.click(n),await o(n).not.toBeInTheDocument();let r=t.getByRole(`button`,{name:/Log out/i});await o(r).toBeInTheDocument()}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{}`,...u.parameters?.docs?.source}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
