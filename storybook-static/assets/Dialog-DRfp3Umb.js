import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./iframe-CuNnu9lR.js";import{b as n,c as r,n as i,r as a,s as o}from"./blocks-CYwqkQf8.js";import{t as s}from"./mdx-react-shim-Bo1qpjQi.js";import{Default as c,NonCloseable as l,n as u,t as d}from"./Dialog.stories-CKNRmEDJ.js";function f(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(o,{of:d}),`
...
`,(0,m.jsx)(t.p,{children:`| Use Dialog when... | Don't use Dialog when... |
|---|---|
...
`,(0,m.jsx)(a,{of:c}),`
`,(0,m.jsxs)(t.p,{children:[`| Position | When to use |
|---|---|
| `,(0,m.jsx)(t.code,{children:`default`}),` | Standard modal — slides up from bottom on mobile, appears centered on desktop |
| `,(0,m.jsx)(t.code,{children:`bottom`}),` | Bottom sheet pattern — selection lists, payment methods, filters |
| `,(0,m.jsx)(t.code,{children:`center`}),` | Centered overlay — success confirmations, small decisions |`]}),`
...
`})}),`
`,(0,m.jsxs)(t.p,{children:[`| Sub-component | Purpose |
|---|---|
| `,(0,m.jsx)(t.code,{children:`DialogHeader`}),` | Title bar with optional close button |
| `,(0,m.jsx)(t.code,{children:`DialogContent`}),` | Scrollable content area with padding |`]}),`
...
| Path | `,(0,m.jsx)(t.code,{children:`packages/libs/ui/src/components/Dialog/`}),` |
| Figma | `,(0,m.jsx)(t.a,{href:`https://www.figma.com/design/FazkRi1zigs8vJlcPzn8Xx/Tipico-Tailwind-DS?node-id=dialog`,rel:`nofollow`,children:`Dialog Component`}),` |
...
`,(0,m.jsxs)(t.p,{children:[`| Custom | DS Dialog |
|---|---|
| `,(0,m.jsx)(t.code,{children:`onClose`}),` prop | `,(0,m.jsx)(t.code,{children:`onCloseClick`}),` prop |
| `,(0,m.jsx)(t.code,{children:`title`}),` on root | `,(0,m.jsx)(t.code,{children:`title`}),` on `,(0,m.jsx)(t.code,{children:`DialogHeader`}),` |
| Auto-visible | Controlled via `,(0,m.jsx)(t.code,{children:`isOpen`}),` |
| No focus management | Auto focus trap + restore |
| No scroll lock | Body scroll locked automatically |`]})]})}function p(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;e((()=>{m=t(),s(),r(),u()}))();export{p as default};